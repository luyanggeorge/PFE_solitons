...
with CheckpointFile("/nobackup/chlw/refine/PFE_sp3_ep01_A05_refine_multi3Ly20cg2/data2d.h5", 'r') as afile:
    mesh2d = afile.load_mesh("mesh2d")
    # h_old = afile.load_function(mesh, "h_old")
    # # phi0 = afile.load_function(mesh, "phi")
    # psi_f = afile.load_function(mesh, "psi_f")
...
if nsavelocalHPC==1: # save_path =  "/nobackup/$USER/lin_pot_flow/"
    save_path =  "/nobackup/chlw/refine/second_PFE_sp3_ep01_A05_refine_multi3Ly20cg2/"
else:
...
t = 0.0+3170.8826152399142
i = 0.0
t_end=t_end+3170.8826152399142
Eend=-4104.640625
